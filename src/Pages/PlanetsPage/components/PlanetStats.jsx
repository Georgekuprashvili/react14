  ...
  return (
    <div className="flex gap-[50px] mt-[200px] w-full justify-center max-md:gap-0 max-md:justify-around ">
      {[
        ...
        >
          <h2 className="text-white font-[Spartan] text-[11px] font-bold leading-[25px] tracking-[1px] uppercase opacity-50 max-md:text-[9px]">
            {info.label}
          </h2>
          <h1 className="text-white font-[Antonio] text-[36px] font-normal leading-normal tracking-[-1.5px] uppercase max-md:text-[16px]">
            {info.value}
          </h1>
        </div>
      ))}
